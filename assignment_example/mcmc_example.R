...
#' bivariate Gaussian distribution. It uses the bivariate standard normal as 
...
#' bivariate Gaussian distribution. Here, the proposal distribution is a random 
...
usethis::create_package("sta380package.example")
