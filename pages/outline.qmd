...
-   Monte Carlo methods, which briefly refers to any simulation-based method in statistical inference. We will start with examples students should be familiar with: simulating the mean, standard error, confidence intervals, MSE, bias, and hypothesis testing. If time permits, I would like to try to simulate other loss functions (MSE alternatives) and the Pitman's closeness criterion.
...
-   Estimating probability density functions. (Will need to think about what methods to discuss...)
