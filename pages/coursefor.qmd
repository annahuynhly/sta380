...
-   This course is crucial if you are planning graduate studies in statistics, especially if you do a thesis.

-   If you are only interested in doing ML and AI, this course is not needed. I recommend `STA314` and `STA315` instead. The CS courses, `CSC311` and `CSC413` are even better. However, if you need an extra statistics course for your degree, this is a better choice than time series analysis, survival analysis, etc.
...
The former is undeniably true; you will employ computational statistics techniques in your thesis. 

I genuinely think if you take the course with me, you will be prepared for the coding aspects for most graduate programs in statistics, and your thesis supervisor should be satisfied with your `R` background.

The latter, referring to the machine learning aspect, is not necessarily true. They can be useful for machine learning, but it is not directly related the same way as the other statistics courses, `STA314` and `STA315` are. The CS courses are especially (and even more) relevant, such as `CSC311` and `CSC413`. You may benefit from learning elementary Monte Carlo methods, bootstrap & jackknife, and numerical optimization.

However, I would not be surprised if you never directly employ these approaches. Furthermore, most numerical optimization techniques are advanced; I will just mention how to use them in `R`. I'll only cover the Newton Raphson and EM algorithms in detail.

Unlike past iterations of the course, I highly believe statistics students should know how to code. You will need this skill for a career and modern graduate studies.
