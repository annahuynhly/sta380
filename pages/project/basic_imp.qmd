...
We write functions for most of the course content, but writing tests and documentation is not frequently emphasized to statistics students.

YouTube tutorial for writing tests.

YouTube tutorial for writing documentation.
